  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@400;500;600;700&family=Inter:wght@400;500;600;700&display=swap"
          rel="stylesheet"
        />
        <link
      ...
      <body className="bg-[#060C09] text-white min-h-screen antialiased font-sans selection:bg-lime-500/30 relative">
        <NavProvider>
          <ShaderBackground />
          <TopNavBar />
          <SideNavBar />
